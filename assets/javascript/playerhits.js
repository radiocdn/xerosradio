class RadioPlayer {
    ...
    loadMediaToCast() {
        ...
        const mediaInfo = new chrome.cast.media.MediaInfo('https://stream2.streamxerosradio.duckdns.org/xerosradiohits', 'audio/mpeg');
    ...
    fetch('https://xerosradioapi.global.ssl.fastly.net/api/xerosradiohits/')
